...
- **Node.js**: 18+ (Required for full functionality - complex model processing)
...
```bash
# Basic conversion (automatic routing)
./voxbridge convert --input model.glb --output-dir ./output --target roblox

# For Unity with optimization
./voxbridge convert --input model.glb --output-dir ./output --target unity --optimize-mesh

# Force complex processing (requires Node.js)
...
# Convert single file (automatic routing - uses best available processor)
./voxbridge convert --input model.glb --output-dir ./output --target roblox

# Force static processing (faster, Python-only - no Node.js required)
./voxbridge convert --input model.glb --output-dir ./output --target unity --force-static

# Force complex processing (preserves animations - requires Node.js 18+)
...
# Advanced options (requires Node.js for full functionality)
./voxbridge convert --input model.glb --output-dir ./output --target roblox \
...
| ---------------- | --------------------------------------- | ----------- | ---------------- |
| `--force-static` | Force static processing path (Trimesh)  | Auto-detect | No               |
| `--force-node`   | Force complex processing path (Node.js) | Auto-detect | Yes              |
