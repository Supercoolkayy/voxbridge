...
class VoxBridgeGUI:
    ...
    def browse_input(self):
        ...
        if filename:
            ...
            output_folder = input_path.parent / f"voxbridge_output_{target}"
        ...
        try:
            ...
            if self.converter:
                ...
                for i, input_file in enumerate(input_files, 1):
                    ...
                    # Generate output path for this file (without extension, converter will add .gltf)
            ...
            if self.converter:
                ...
                for i, input_file in enumerate(input_files, 1):
                    ...
                    try:
                        ...
                        # Use unified pipeline runner for consistency with CLI
                        result = run_unified_pipeline(
                            "convert", input_file, output_folder, target, options, verbose
                        )
                        success = result.get('success', False)
